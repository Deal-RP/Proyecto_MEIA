 ...
 * @author pablo
 */
public class InboxSend extends javax.swing.JFrame {
    ABB ABB = new ABB();
    /**
    ...
    public InboxSend() {
        initComponents();
         try{
            ...
            ABB.Cargar();
            var tempList = ABB.display_msg_(user, 0);
            ShowEmails( tempList);
    ...
    private void jButton_recargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_recargarActionPerformed
       ...
       var List_msg = ABB.display_msg_(user, 0);
       ShowEmails(List_msg);
    ...
    private void jButton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_buscarActionPerformed
        ...
        var List_use = ABB.search_user_(user, Name,1,0);
        ShowEmails(List_use);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InboxSend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
